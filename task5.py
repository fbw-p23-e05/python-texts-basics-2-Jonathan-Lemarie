...
last_letters = text[-10:]  # putting the : after the amount desired in the bracket instead of before will take the last characters instead of the beginning of that variable.
